...
namespace AoC2023Tests
{
    public class Day07Test
    {
        ...
        public void CardStrength1ShouldBeComparedCorrect(string h1, string h2, int e)
        {
            var c1 = new Day07.Card(h1, 0);
            var c2 = new Day07.Card(h2, 0);
            Assert.That(c1.Type1 == c2.Type1);

            var c = new Day07.Comparer(Day07.LabelsPart1, Day07.CompareCardType, true);

            Assert.That(c.Compare(c1, c2), Is.EqualTo(e));
        }

        [TestCase("AAAAA", "AA8AA", 1)]
        [TestCase("23332", "TTT98", 1)]
        public void CardType1ShouldBeComparedCorrect(string h1, string h2, int e)
        {
	        var c1 = new Day07.Card(h1, 0);
	        var c2 = new Day07.Card(h2, 0);
	        var c = new Day07.Comparer(Day07.LabelsPart2, Day07.CompareCardType, false);
